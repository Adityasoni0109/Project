...
<body>
	...
	$userData	=	$db->getAllRecords('central','*',$condition,'ORDER BY id DESC');
	?>
   	<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-3">
								<div class="form-group">
									...
									<input type="text" name="criteria" id="criteria" class="form-control" value="<?php echo isset($_REQUEST['criteria'])?$_REQUEST['criteria']:''?>" placeholder="Enter criteria">
								</div>
							</div>
