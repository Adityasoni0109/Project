...
<body>
	...
	$userData	=	$db->getAllRecords('state','*',$condition,'ORDER BY id DESC');
	?>
   	<div class="container">
		<h1><em style="color: #f5a425;;" >FIND</em> MY SCHOLARSHIP</h1>
		<h3>View</h3>
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Browse state Scholarships</strong></div>
			<div class="card-body">
				<?php
